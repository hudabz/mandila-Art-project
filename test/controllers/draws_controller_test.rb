...
class DrawsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create draw" do
    assert_difference('Draw.count') do
      post draws_url, params: { draw: { description: @draw.description, painting: @draw.painting, tools: @draw.tools } }
    end
  ...
  test "should update draw" do
    patch draw_url(@draw), params: { draw: { description: @draw.description, painting: @draw.painting, tools: @draw.tools } }
